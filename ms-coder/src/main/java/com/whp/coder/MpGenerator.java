...
public class MpGenerator {
    ...
    public static final String table_names="dept";
    ...
    public static void makeCode() {
        ...
        tc.setController("ms_coder_template/controller.java2.vm");
        tc.setEntity("ms_coder_template/entity.java2.vm");
        tc.setMapper("ms_coder_template/mapper.java2.vm");
        tc.setXml("ms_coder_template/mapper.xml2.vm");
        tc.setService("ms_coder_template/service.java2.vm");
        tc.setServiceImpl("ms_coder_template/serviceImpl.java2.vm");
